...
module.exports = (app) => {
  app.get("/canvas/filtermagentax", checkApiKeyAndLimit, async (req, res) => {
    try {
      ...
      const apiUrl = `https://api.some-random-api.com/canvas/filter/blurple2?color=FF4FF4&avatar=${encodeURIComponent(imageUrl)}`;
