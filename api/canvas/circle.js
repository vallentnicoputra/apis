...
module.exports = (app) => {
  app.get("/canvas/circle", checkApiKeyAndLimit, async (req, res) => {
    try {//
      ...
      const apiUrl = `https://api.some-random-api.com/canvas/misc/circle?avatar=${encodeURIComponent(imageUrl)}`;
