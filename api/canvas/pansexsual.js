...
module.exports = (app) => {
  app.get("/canvas/pansexsual", checkApiKeyAndLimit, async (req, res) => {
    try {
      ...
      const apiUrl = `https://api.some-random-api.com/canvas/misc/pansexsual?avatar=${encodeURIComponent(imageUrl)}`;
