...
module.exports = (app) => {
  app.get("/canvas/filterblurple", checkApiKeyAndLimit, async (req, res) => {
    try {
      ...
      const apiUrl = `https://api.some-random-api.com/canvas/filter/blurple?avatar=${encodeURIComponent(imageUrl)}`;
