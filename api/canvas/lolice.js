...
module.exports = (app) => {
  app.get("/canvas/lolice", checkApiKeyAndLimit, async (req, res) => {
    try {
      ...
      const apiUrl = `https://api.some-random-api.com/canvas/misc/lolice?avatar=${encodeURIComponent(imageUrl)}`;
