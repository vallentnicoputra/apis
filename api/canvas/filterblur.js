...
module.exports = (app) => {
  app.get("/canvas/filterblur", checkApiKeyAndLimit, async (req, res) => {
    try {
      ...
      const apiUrl = `https://api.some-random-api.com/canvas/filter/blur?avatar=${encodeURIComponent(imageUrl)}`;
