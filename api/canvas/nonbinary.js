...
module.exports = (app) => {
  app.get("/canvas/nonbinary", checkApiKeyAndLimit, async (req, res) => {
    try {
      ...
      const apiUrl = `https://api.some-random-api.com/canvas/misc/nonbinary?avatar=${encodeURIComponent(imageUrl)}`;
