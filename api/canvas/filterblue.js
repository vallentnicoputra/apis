...
module.exports = (app) => {
  app.get("/canvas/filterblue", checkApiKeyAndLimit, async (req, res) => {
    try {
      ...
      const apiUrl = `https://api.some-random-api.com/canvas/filter/blue?avatar=${encodeURIComponent(imageUrl)}`;
