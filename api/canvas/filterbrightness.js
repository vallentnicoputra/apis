...
module.exports = (app) => {
  app.get("/canvas/filterbrightness", checkApiKeyAndLimit, async (req, res) => {
    try {
      ...
      const apiUrl = `https://api.some-random-api.com/canvas/filter/brightness?avatar=${encodeURIComponent(imageUrl)}`;
