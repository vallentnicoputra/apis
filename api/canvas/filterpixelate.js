...
module.exports = (app) => {
  app.get("/canvas/filterpixelate", checkApiKeyAndLimit, async (req, res) => {
    try {
      ...
      const apiUrl = `https://api.some-random-api.com/canvas/filter/pixelate?avatar=${encodeURIComponent(imageUrl)}`;
