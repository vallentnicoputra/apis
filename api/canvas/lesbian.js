...
module.exports = (app) => {
  app.get("/canvas/lesbian", checkApiKeyAndLimit, async (req, res) => {
    try {
      ...
      const apiUrl = `https://api.some-random-api.com/canvas/misc/lesbian?avatar=${encodeURIComponent(imageUrl)}`;
