...
module.exports = (app) => {
  app.get("/canvas/filterblurple2", checkApiKeyAndLimit, async (req, res) => {
    try {
      ...
      const apiUrl = `https://api.some-random-api.com/canvas/filter/blurple2?avatar=${encodeURIComponent(imageUrl)}`;
