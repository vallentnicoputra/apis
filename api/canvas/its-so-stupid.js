...
module.exports = (app) => {
  app.get("/canvas/its-so-stupid", checkApiKeyAndLimit, async (req, res) => {
    try {
      ...
      const apiUrl = `https://api.some-random-api.com/canvas/misc/its-so-stupid?dog=anjing&avatar=${encodeURIComponent(imageUrl)}`;
