...
module.exports = (app) => {
  app.get("/canvas/bisexsual", checkApiKeyAndLimit, async (req, res) => {
    try {
      ...
      const apiUrl = `https://api.some-random-api.com/canvas/misc/bisexual?avatar=${encodeURIComponent(imageUrl)}`;
