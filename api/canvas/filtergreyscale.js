...
module.exports = (app) => {
  app.get("/canvas/filtergreyscale", checkApiKeyAndLimit, async (req, res) => {
    try {
      ...
      const apiUrl = `https://api.some-random-api.com/canvas/filter/greyscale?avatar=${encodeURIComponent(imageUrl)}`;
