...
module.exports = (app) => {
  app.get("/canvas/tonikawa", checkApiKeyAndLimit, async (req, res) => {
    try {
      ...
      const apiUrl = `https://api.some-random-api.com/canvas/misc/tonikawa?avatar=${encodeURIComponent(imageUrl)}`;
