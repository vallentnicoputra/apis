...
module.exports = (app) => {
  app.get("/canvas/transgender", checkApiKeyAndLimit, async (req, res) => {
    try {
      ...
      const apiUrl = `https://api.some-random-api.com/canvas/misc/transgender?avatar=${encodeURIComponent(imageUrl)}`;
