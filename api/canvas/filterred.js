...
module.exports = (app) => {
  app.get("/canvas/filterred", checkApiKeyAndLimit, async (req, res) => {
    try {
      ...
      const apiUrl = `https://api.some-random-api.com/canvas/filter/red?avatar=${encodeURIComponent(imageUrl)}`;
