...
class MetaAI {
  ...
  let line = decoder.decode(chunk, { stream: true });
  console.log("[MetaAI] Raw chunk received:", line);  // <-- tambah log ini
  prevLine += line;
