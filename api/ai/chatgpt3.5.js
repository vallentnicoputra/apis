...
const { checkApiKeyAndLimit } = require('../../middleware'); // <-- HAPUS BARIS INI

module.exports = (app) => { // Pastikan Anda menerima checkApiKeyAndLimit di sini
//Scraper gpt
class ChatAPI {
  constructor() {
    this.models = ["gpt-4.1"];
