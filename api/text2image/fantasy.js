...
class AIFreeBoxAI {
  constructor() {
    ...
    this.session = axios.create({
      ...
      headers: {
        ...
        pragma: "no-cache",
        priority: "u=1, i",
        referer: "https://aifreebox.com/image-generator/ai-fantasy-character-creator",
  ...
  async generateImage({
    prompt,
    ratio = "4:5",
    slug = "ai-fantasy-character-creator"
  }) {
    try {
  ...
  app.get("/text2image/fantasy", checkApiKeyAndLimit, async (req, res) => {
    try {
