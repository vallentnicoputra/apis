...
class AIFreeBoxAI {
  constructor() {
    ...
    this.session = axios.create({
      ...
      headers: {
        ...
        pragma: "no-cache",
        priority: "u=1, i",
        referer: "https://aifreebox.com/image-generator/ai-artface-image-generator",
  ...
  async generateImage({
    prompt,
    ratio = "4:5",
    slug = "ai-artface-image-generator"
  }) {
    try {
  ...
  app.get("/text2image/artface", checkApiKeyAndLimit, async (req, res) => {
    try {
