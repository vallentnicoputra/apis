...
class AIFreeBoxAI {
  constructor() {
    ...
    this.session = axios.create({
      ...
      headers: {
        ...
        pragma: "no-cache",
        priority: "u=1, i",
        referer: "https://aifreebox.com/image-generator/ai-wood-carving-ideas-generator",
  ...
  async generateImage({
    prompt,
    ratio = "4:5",
    slug = "ai-wood-carving-ideas-generator"
  }) {
    try {
  ...
  app.get("/text2image/woodcarving", checkApiKeyAndLimit, async (req, res) => {
    try {
