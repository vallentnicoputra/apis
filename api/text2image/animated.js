...
module.exports = (app) => {
  ...
  constructor() {
    ...
    this.session = axios.create({
      ...
      headers: {
        ...
        pragma: "no-cache",
        priority: "u=1, i",
        referer: "https://aifreebox.com/image-generator/ai-animated-characters-generator",
  ...
  async generateImage({
    prompt,
    ratio = "4:5",
    slug = "ai-animated-characters-generator"
  }) {
    try {
  ...
  app.get("/text2image/animated", checkApiKeyAndLimit, async (req, res) => {
    try {
