...
module.exports = (app) => {
 class AIFreeBoxAI {
  constructor() {
    ...
    this.session = axios.create({
      ...
      headers: {
        ...
        pragma: "no-cache",
        priority: "u=1, i",
        referer: "https://aifreebox.com/image-generator/ai-lo-fi-wallpaper-generator",
  ...
  async generateImage({
    prompt,
    ratio = "4:5",
    slug = "ai-lo-fi-wallpaper-generator"
  }) {
    try {
  ...
  app.get("/text2image/lofiwallpaper", checkApiKeyAndLimit, async (req, res) => {
    try {
