...
class AIFreeBoxAI {
  constructor() {
    ...
    this.session = axios.create({
      ...
      headers: {
        ...
        pragma: "no-cache",
        priority: "u=1, i",
        referer: "https://aifreebox.com/image-generator/ai-scary-drawings-generator",
  ...
  async generateImage({
    prompt,
    ratio = "4:5",
    slug = "ai-scary-drawings-generator"
  }) {
    try {
  ...
  app.get("/text2image/scarydrawing", checkApiKeyAndLimit, async (req, res) => {
    try {
