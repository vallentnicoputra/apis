...
class AIFreeBoxAI {
  constructor() {
    ...
    this.session = axios.create({
      ...
      headers: {
        ...
        pragma: "no-cache",
        priority: "u=1, i",
        referer: "https://aifreebox.com/image-generator/ai-auroraforge-image-generator",
  ...
  async generateImage({
    prompt,
    ratio = "4:5",
    slug = "ai-auroraforge-image-generator"
  }) {
    try {
  ...
  app.get("/text2image/auroraforge", checkApiKeyAndLimit, async (req, res) => {
    try {
