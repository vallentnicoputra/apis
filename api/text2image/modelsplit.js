...
module.exports = (app) => {
  ...
  constructor() {
    ...
    this.session = axios.create({
      ...
      headers: {
        ...
        pragma: "no-cache",
        priority: "u=1, i",
        referer: "https://aifreebox.com/image-generator/ai-model-split-photo-creator",
  ...
  async generateImage({
    prompt,
    ratio = "4:5",
    slug = "ai-model-split-photo-creator"
  }) {
    try {
  ...
  app.get("/text2image/modelsplit", checkApiKeyAndLimit, async (req, res) => {
    try {
