...
class AIFreeBoxAI {
  constructor() {
    ...
    this.session = axios.create({
      ...
      headers: {
        ...
        pragma: "no-cache",
        priority: "u=1, i",
        referer: "https://aifreebox.com/image-generator/ai-pixelpop-generator",
  ...
  app.get("/text2image/pixelpop", checkApiKeyAndLimit, async (req, res) => {
    try {
