...
module.exports = (app) => {
  ...
  constructor() {
    ...
    this.session = axios.create({
      ...
      headers: {
        ...
        pragma: "no-cache",
        priority: "u=1, i",
        referer: "https://aifreebox.com/image-generator/ai-black-anime-girl-generator",
  ...
  async generateImage({
    prompt,
    ratio = "4:5",
    slug = "ai-black-anime-girl-generator"
  }) {
    try {
  ...
  app.get("/text2image/blackanime", checkApiKeyAndLimit, async (req, res) => {
    try {
