...
module.exports = (app) => {
  ...
  constructor() {
    ...
    this.session = axios.create({
      ...
      headers: {
        ...
        pragma: "no-cache",
        priority: "u=1, i",
        referer: "https://aifreebox.com/image-generator/ai-bizart-illustration-generator",
  ...
  async generateImage({
    prompt,
    ratio = "4:5",
    slug = "ai-bizart-illustration-generator"
  }) {
    try {
  ...
  app.get("/text2image/bizzart", checkApiKeyAndLimit, async (req, res) => {
    try {
