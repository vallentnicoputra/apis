...
class AIFreeBoxAI {
  constructor() {
    ...
    this.session = axios.create({
      ...
      headers: {
        ...
        pragma: "no-cache",
        priority: "u=1, i",
        referer: "https://aifreebox.com/image-generator/ai-simpleline-character-creator",
  ...
  async generateImage({
    prompt,
    ratio = "4:5",
    slug = "ai-simpleline-character-creator"
  }) {
    try {
  ...
  app.get("/text2image/simpleline", checkApiKeyAndLimit, async (req, res) => {
    try {
