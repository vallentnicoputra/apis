...
module.exports = (app) => {
  class AIFreeBoxAI {
    constructor() {
      ...
      this.session = axios.create({
        ...
        headers: {
          ...
          pragma: "no-cache",
          priority: "u=1, i",
          referer: "https://aifreebox.com/image-generator/ai-3d-cartoon-character-generator",
    ...
    async generateImage({ prompt, ratio = "4:5", slug = "ai-photo-generator" }) {
      try {
  ...
  app.get("/text2image/photogenerator", checkApiKeyAndLimit, async (req, res) => {
    try {
