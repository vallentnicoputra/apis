...
class AIFreeBoxAI {
  constructor() {
    ...
    this.session = axios.create({
      ...
      headers: {
        ...
        pragma: "no-cache",
        priority: "u=1, i",
        referer: "https://aifreebox.com/image-generator/ai-anime-character-generator",
  ...
  async generateImage({
    prompt,
    ratio = "4:5",
    slug = "ai-anime-character-generator"
  }) {
    try {
  ...
  app.get("/text2image/oldcartoon", checkApiKeyAndLimit, async (req, res) => {
    try {
