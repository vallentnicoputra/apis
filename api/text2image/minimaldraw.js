...
class AIFreeBoxAI {
  constructor() {
    ...
    this.session = axios.create({
      ...
      headers: {
        ...
        pragma: "no-cache",
        priority: "u=1, i",
        referer: "https://aifreebox.com/image-generator/ai-minimaldraw-image-generator",
  ...
  async generateImage({
    prompt,
    ratio = "4:5",
    slug = "ai-minimaldraw-image-generator"
  }) {
    try {
  ...
  app.get("/text2image/minimaldraw", checkApiKeyAndLimit, async (req, res) => {
    try {
