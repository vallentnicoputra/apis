...
module.exports = (app) => {
  ...
  constructor() {
    ...
    this.session = axios.create({
      ...
      headers: {
        ...
        pragma: "no-cache",
        priority: "u=1, i",
        referer: "https://aifreebox.com/image-generator/ai-film-style-photographs-generator",
  ...
  async generateImage({
    prompt,
    ratio = "4:5",
    slug = "ai-film-style-photographs-generator"
  }) {
    try {
  ...
  app.get("/text2image/film", checkApiKeyAndLimit, async (req, res) => {
    try {
