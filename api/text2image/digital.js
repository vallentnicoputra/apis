...
module.exports = (app) => {
  ...
  constructor() {
    ...
    this.session = axios.create({
      ...
      headers: {
        ...
        pragma: "no-cache",
        priority: "u=1, i",
        referer: "https://aifreebox.com/image-generator/ai-digital-circuit-aesthetic-creator",
  ...
  async generateImage({
    prompt,
    ratio = "4:5",
    slug = "ai-digital-circuit-aesthetic-creator"
  }) {
    try {
  ...
  app.get("/text2image/digital", checkApiKeyAndLimit, async (req, res) => {
    try {
