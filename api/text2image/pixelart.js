...
class AIFreeBoxAI {
  constructor() {
    ...
    this.session = axios.create({
      ...
      headers: {
        ...
        pragma: "no-cache",
        priority: "u=1, i",
        referer: "https://aifreebox.com/image-generator/ai-pixel-art-generator",
  ...
  app.get("/text2image/pixelart", checkApiKeyAndLimit, async (req, res) => {
    try {
