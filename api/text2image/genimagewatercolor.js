...
module.exports = (app) => {
  ...
  class PadletImageGenerator {
    ...
    async generate({ prompt = "style, Realistic in a gentle watercolor style, with flowing color washes, soft edges, and subtle shading", ratio = "16:9" }) {
      const url = `${this.padletApiBase}/ai-generate-image`;
      const headers = this.buildHeaders();
      const body = { prompt, ratio };
  ...
  app.get("/text2image/genimagewatercolor", checkApiKeyAndLimit, async (req, res) => {
    try {
