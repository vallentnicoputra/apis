...
module.exports = (app) => {
  ...
  constructor() {
    ...
    this.session = axios.create({
      ...
      headers: {
        ...
        pragma: "no-cache",
        priority: "u=1, i",
        referer: "https://aifreebox.com/image-generator/ai-lofi-dreams-images-generator",
  ...
  async generateImage({
    prompt,
    ratio = "4:5",
    slug = "ai-lofi-dreams-images-generator"
  }) {
    try {
...
///Code nya wak 
  ...
  app.get("/text2image/lofidreams", checkApiKeyAndLimit, async (req, res) => {
    try {
