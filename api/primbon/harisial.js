...
module.exports = (app) => {
  app.get("/primbon/harisial", checkApiKeyAndLimit, async (req, res) => {
    try {
      ...
      // Panggil API primbon
      const anu = await primbon.primbon_hari_naas(
        Number(tgl),
        Number(bln),
        Number(thn)
      );
      ...
      const data = {
        hari_lahir: anu.message.hari_lahir,
        tgl_lahir: anu.message.tgl_lahir,
        hari_naas: anu.message.hari_naas,
